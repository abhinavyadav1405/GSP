...
useEffect(() => {
  ...
  { id: 'schemes' as const, label: 'Schemes', icon: <Landmark size={16} /> },
  { id: 'notices' as const, label: 'Notices', icon: <Bell size={16} /> },
  { id: 'achievements' as const, label: 'Achievements', icon: <Award size={16} /> },
  { id: 'profile' as const, label: currentUser ? 'Profile' : 'Login', icon: <User size={16} /> }
];
